...
def parsed_args():
    ...
    parser.add_argument("-i", "--instance_id", help="the instance id you want to snapshot.  default: current instance id", default=boto.utils.get_instance_metadata()['instance-id'])
    parser.add_argument('-m', "--mount_point", help="the mount moint you're searching for. default: /dev/sdf", default='/dev/sdf')
    parser.add_argument('-r', "--region", help="the region you're in. default: us-west-2", default='us-west-2')
    parser.add_argument('-t', "--tag", help="the tag you'd like to apply to the snapshot. default: codepen-app", default='codepen-app')
